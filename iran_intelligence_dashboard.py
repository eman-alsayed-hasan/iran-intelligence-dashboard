...
2026-03-23 18:28 UTC,AE144F,RCH580,32.8123,32.7240,36000,384,False,RAF Akrotiri,200,United States
2026-03-23 18:28 UTC,AE0451,RG04,29.9366,33.7162,13075,324,False,Tabuk AB,366,United States
2026-03-23 18:28 UTC,AE0800,RCH302,35.4662,28.1351,34000,390,False,Souda Bay,442,United States
2026-03-23 18:28 UTC,AE0560,RCH1873,35.3056,26.8091,31000,492,False,Souda Bay,296,United States
2026-03-23 18:28 UTC,A97C49,CMB553,34.6477,27.6338,33000,486,False,Souda Bay,399,United States
2026-03-23 18:28 UTC,AE117D,RCH648,41.0019,24.7835,29000,456,False,Souda Bay,611,United States
2026-03-23 18:28 UTC,AE144F,RCH580,32.8313,32.6870,36000,383,False,RAF Akrotiri,198,United States
2026-03-23 18:28 UTC,AE0451,RG04,29.9186,33.7432,13050,324,False,Tabuk AB,363,United States
2026-03-23 18:28 UTC,AE0800,RCH302,35.4954,28.0921,34000,390,False,Souda Bay,438,United States
2026-03-23 18:28 UTC,AE0560,RCH1873,35.3056,26.8091,31000,492,False,Souda Bay,296,United States
2026-03-23 18:28 UTC,A97C49,CMB553,34.6477,27.6338,33000,486,False,Souda Bay,399,United States
2026-03-23 18:28 UTC,AE117D,RCH648,40.9528,24.8031,29000,456,False,Souda Bay,606,United States
"""
...
Multi-INT Analysis | ADS-B + AIS + OSINT | Mar 23, 2026 | UNCLASSIFIED
</p>
""", unsafe_allow_html=True)
...
with tab5:
    ...
    st.markdown("---")
    st.markdown("#### LinkedIn Post Template — Based on This Dashboard")
    linkedin_text = """🔍 INTELLIGENCE INSIGHT: The "Countdown to Resupply" Signal

Using open-source ADS-B tracking (OpenSky Network), satellite imagery (Planet Labs), and published defence reporting (USNI News, AP, The War Zone), I've been monitoring the US military buildup surrounding Iran for the past 30 days.

Today's finding: The current 310+ aircraft force has been operating at surge tempo since Feb 17. Based on published USAF logistics doctrine and confirmed fuel/ammo data, the sustainment model shows:

⏱ Fuel at forward bases → 25% around Day 12 (≈ March 12)
💥 Ammo capacity → critical threshold around Day 18 (≈ March 18)  
✈ Sortie rate degradation begins → Day 10 (≈ March 10)

This means: the window for maximum operational tempo closes in approximately 10 days. After that, the force either receives a major maritime resupply (USS Medgar Evers + MPS ships currently on station) — or it transitions to a lower sustained tempo.

The next 10 days will determine whether this is coercive diplomacy or genuine preparation.

Methodology: ADS-B public broadcasts + AIS public data + published DoD doctrine
All data sources open and verifiable. No classified information used.

#OSINT #GeoAI #IntelligenceAnalysis #OpenSourceIntelligence #StrategicAnalysis"""

    st.text_area("Copy this for LinkedIn:", linkedin_text, height=320)
